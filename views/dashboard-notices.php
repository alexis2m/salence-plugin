	...
	<p>
		<?php
			printf(
				...
				__( 'Thank you for installing %1$s! ', 'salence-pixel' ),
				$this->plugin->displayName
			); ?>
		<a href="<?php echo $setting_page; ?>"><?php esc_html_e( 'Click here', 'salence-pixel' ); ?></a> <?php esc_html_e( 'to configure the plugin.', 'salence-pixel' ); ?>
	</p>
</div>
